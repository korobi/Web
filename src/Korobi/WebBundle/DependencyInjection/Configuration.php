...
class Configuration implements ConfigurationInterface {
    ...
    public function getConfigTreeBuilder() {
        ...
        ->end()->booleanNode("requires_auth")->defaultValue(false)->end()->booleanNode("requires_admin")->defaultValue(false)->end()
        ->booleanNode("external")->defaultValue(false)->end()->end()->end();
        return $treeBuilder;
    }
}
